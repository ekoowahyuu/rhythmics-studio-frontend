...
const ForgotPassword = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    setIsContinueDisabled(
      inputEmail.trim() === "" || !isValidEmail(inputEmail)
    );
    setEmailError("");
  };
          ...
          <div className="w-1/2 h-full flex flex-col justify-center items-center text-white p-8 sm:p-16 lg:p-32">
            ...
            >
              ...
              <div className="w-full flex flex-col space-y-2 mt-6">
                <button
                  type="submit"
                  className="w-full p-3 rounded-lg bg-primary2 text-[#AB886D] hover:text-[#FFFFFF] font-semibold hover:bg-[#B17457] transition flex justify-center items-center"
